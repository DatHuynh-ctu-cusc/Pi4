...
from path_node import execute_path   # ✅ Thêm dòng này
import shared_state
...
def on_bt_receive(msg):
    ...
    if cmd == "forward":
        ...
        path_data = msg[5:].strip()
        shared_state.running_scan = False  # ✅ Dừng chế độ tự hành nếu đang chạy
        print("[BT] 🧭 Đang thực hiện đường đi được gửi từ Pi5...")
